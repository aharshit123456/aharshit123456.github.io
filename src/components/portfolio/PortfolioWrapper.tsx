              ...
              {renderSectionItems([
                <div className="exp-item" key="famcare" onContextMenu={(e) => {
                  ...
                  <div className="details">
                    ...
                    <ul>
                      <li><strong>Architected and delivered</strong> the FamCARE full-stack ecosystem — a <strong>FastAPI backend</strong>, a <strong>Flutter</strong> customer app, a <strong>Capacitor</strong>-based caretaker app, a <strong>Next.js</strong> admin dashboard, an internal agent tooling repo, and a Terraform infra repo — scaling from zero to production across <strong>6 repositories</strong>. Personally authored <strong>2,434 commits</strong> as the top contributor on every repo.</li>
                      ...
                      <li><strong>Mentored and led a team of 7 engineering interns</strong>, hand-holding them through codebase ramp-up, code reviews, and best practices — the team collectively shipped <strong>1,581 commits</strong> across the same 6 repos under direct technical guidance.</li>
