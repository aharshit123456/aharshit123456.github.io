  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Body / Outfit */}
        <rect x="10" y="20" width="12" height="8" fill="#1e293b" /> {/* Main coat */}
        <rect x="9" y="22" width="14" height="6" fill="#1e293b" />
        <rect x="11" y="24" width="10" height="6" fill="#f8fafc" /> {/* Dress/Shirt */}
        
        {/* Arms */}
        <motion.g animate={{ rotate: isSpinning ? [0, 20, -20, 0] : 0 }}>
          <rect x="6" y="21" width="5" height="3" fill="#1e293b" /> {/* Left arm */}
          <rect x="21" y="21" width="5" height="3" fill="#1e293b" /> {/* Right arm */}
          <rect x="5" y="21" width="1" height="3" fill="#f8fafc" /> {/* Sleeves */}
        ...
        <rect x="7" y="12" width="3" height="6" fill="#94a3b8" /> {/* Side bangs */}
        <rect x="22" y="12" width="3" height="6" fill="#94a3b8" />
        <rect x="10" y="7" width="12" height="2" fill="#475569" /> {/* Hair shadow/top */}
        <rect x="20" y="9" width="4" height="2" fill="#a855f7" opacity="0.6" /> {/* Purple highlight */}

        {/* Beret / Hat */}
        <rect x="9" y="5" width="14" height="4" rx="1" fill="#0f172a" />
        <rect x="15" y="4" width="2" height="2" fill="#a855f7" /> {/* Hat gem */}
        ...
        {/* Gold Accents */}
        <rect x="14" y="21" width="4" height="1" fill="#eab308" /> {/* Collar/Gold part */}
